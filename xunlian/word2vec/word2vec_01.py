...
fold_num = 10
data_file = '/jianxq/xunlian/zhengti_fenci.csv'
import pandas as pd
...
# save model
model.save("/jianxq/xunlian/word2vec.bin")

# load model
model = Word2Vec.load("/jianxq/xunlian/word2vec.bin")

# convert format
model.wv.save_word2vec_format('/jianxq/xunlian/word2vec.txt', binary=False)
